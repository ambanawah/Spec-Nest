    ...
    <>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 md:px-20 bg-surface-container-low">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
          <Link href="/catalog" className="md:col-span-8 h-80 md:h-auto group relative overflow-hidden rounded-xl bg-surface-container-high cursor-pointer transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
            <img
            ...
            <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8">
              <h3 className="font-headline text-2xl sm:text-3xl font-black text-[#e2e0fc] mb-2 tracking-tighter">LAPTOPS</h3>
              <p className="font-label text-xs tracking-widest text-primary uppercase">Mobile Powerhouses</p>
            </div>
          </Link>
          <Link href="/catalog/desktops" className="md:col-span-4 h-80 md:h-auto group relative overflow-hidden rounded-xl bg-surface-container-high cursor-pointer transition-all duration-500 hover:shadow-2xl hover:shadow-secondary/10">
            <img
              className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-50"
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent" />
            <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8">
              <h3 className="font-headline text-2xl sm:text-3xl font-black text-[#e2e0fc] mb-2 tracking-tighter">CUSTOM DESKTOPS</h3>
              <p className="font-label text-xs tracking-widest text-secondary uppercase">Precision Built</p>
            </div>
          </Link>
          <Link href="/component-library" className="md:col-span-12 h-96 md:h-[400px] group relative overflow-hidden rounded-xl bg-surface-container-high cursor-pointer transition-all duration-500 hover:shadow-2xl hover:shadow-white/5">
            <img
            ...
            <div className="absolute inset-y-0 left-6 sm:left-8 flex flex-col justify-center max-w-md">
              <h3 className="font-headline text-3xl sm:text-4xl font-black text-[#e2e0fc] mb-4 tracking-tighter leading-none">GRAPHICS CARDS</h3>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 md:px-20 bg-surface-container-lowest">
        <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
          <h2 className="font-headline text-3xl sm:text-4xl font-extrabold tracking-tighter mb-4 text-on-surface">THE SPECNEST EDGE</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-primary to-secondary mx-auto rounded-full" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="flex flex-col items-center text-center p-6 sm:p-8 rounded-xl border border-outline-variant/10 hover:border-primary/20 transition-all duration-300">
          ...
          <div className="flex flex-col items-center text-center p-6 sm:p-8 rounded-xl border border-outline-variant/10 hover:border-secondary/20 transition-all duration-300">
            <div className="w-16 h-16 rounded-full bg-surface-container-high flex items-center justify-center mb-6 shadow-xl shadow-black/20">
          ...
          <div className="flex flex-col items-center text-center p-6 sm:p-8 rounded-xl border border-outline-variant/10 hover:border-tertiary/20 transition-all duration-300">
            <div className="w-16 h-16 rounded-full bg-surface-container-high flex items-center justify-center mb-6 shadow-xl shadow-black/20">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 md:px-20">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-surface-container-high to-surface-container-lowest p-8 sm:p-12 md:p-20 flex flex-col md:flex-row items-center gap-8 md:gap-12 border border-outline-variant/10">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="font-headline text-3xl md:text-5xl font-black tracking-tight text-on-surface mb-4 md:mb-6">NEVER MISS A <span className="text-primary">SPEC DROP</span>.</h2>
          ...
          <div className="w-full md:w-auto flex flex-col sm:flex-row gap-4">
            <input className="bg-surface-container-lowest border border-outline-variant/20 rounded-md px-6 py-4 focus:ring-primary focus:border-primary text-on-surface w-full sm:min-w-[300px]" placeholder="Your engineering email" type="email" />
